	...
	<div class="container"  style="background-color: #EAEAEA;" >
		...
		<table class="table">
			...
			<tr>
				...
				<td><pre style="background: #EAEAEA; border: none; font-size: 11pt">${vo.content }</pre></td>
			</tr>
			<tr>
				<th>작성자</th>
			...
			<tr>
				<td colspan="2">
					<a href="notice_update.do?no=${vo.no}&inc=0&page=${param.page}&perPageNum=${param.perPageNum}&word=${param.word}&start_date=${param.start_date}&end_date=${param.end_date}"
					role="button" class="btn btn-default">수정</a> 
					<a href="notice_admin.do?page=${param.page}&perPageNum=${param.perPageNum}&word=${param.word}&start_date=${param.start_date}&end_date=${param.end_date}"
