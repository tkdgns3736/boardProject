...
<body>
	...
	<div class="container">
		...
		<!-- 	<tr>
			...
			<tr>
				<td colspan="2"><a
					href="update.do?no=${vo.no}&inc=0&page=${param.page}&perPageNum=${param.perPageNum}&Key=${param.key}&word=${param.word}&start_date=${param.start_date}&end_date=${param.end_date}&sort=${param.sort}"
					role="button" class="btn btn-default">수정</a> 
					
					<a href="delete.do?no=${vo.no}&page=${param.page}&perPageNum=${param.perPageNum}&Key=${param.key}&word=${param.word}&start_date=${param.start_date}&end_date=${param.end_date}&sort=${param.sort}" 
					role="button" class="btn btn-default">삭제</a>
					
					<c:if test="${param.value ne null}">
						<a
					href="user_info.do?page=${param.page}&perPageNum=${param.perPageNum}&Key=${param.key}&word=${param.word}&start_date=${param.start_date}&end_date=${param.end_date}&sort=${param.sort}"
					class="btn btn-default">리스트</a>
				</c:if>
				<c:if test="${param.value eq null}">
					<a
					href="list.do?page=${param.page}&perPageNum=${param.perPageNum}&Key=${param.key}&word=${param.word}&start_date=${param.start_date}&end_date=${param.end_date}&sort=${param.sort}"
					class="btn btn-default">리스트</a>
