package com.webjjang.board.PageObject;

import javax.servlet.http.HttpServletRequest;

public class pageObject_notice {
	...
	public pageObject_notice(long page, long perPageNum) {
		this.page = page;
	...
	public static pageObject_notice getInstance(HttpServletRequest request) throws Exception {

		// 페이지 처리를 위한 프로그램
		// 페이지 처리를 위한 객체 사용
		pageObject_notice pageObject = new pageObject_notice();
		// 페이지에 대한 정보를 받는다.
	...
	public static pageObject_notice getInstance(HttpServletRequest request, String pageName, String perPageNumName) throws Exception {
	...
	public String toString() {
		return "pageObject_notice [page=" + page + ", perPageNum=" + perPageNum + ", startRow=" + startRow + ", endRow="
				+ endRow + ", perGroupPageNum=" + perGroupPageNum + ", startPage=" + startPage + ", endPage=" + endPage
				+ ", totalPage=" + totalPage + ", totalRow=" + totalRow + ", word=" + word + ", start_date="
				+ start_date + ", end_date=" + end_date + ", popup_date=" + popup_date + ", period=" + period
				+ ", accepter=" + accepter + ", acceptMode=" + acceptMode + "]";
	}
