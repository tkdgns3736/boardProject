	...
	$(function() {
		...
		$(".dataRow").click(
				function() {
					...
					location = "view_admin.do?no=" + no + "&inc=0"
...
<body>
	...
	<nav>
     ...
     <div style="border: 1px solid #EAEAEA; padding: 10px; height: auto; min-height: 30px; overflow: auto ;">
				<h2 style="display:inline;"><a href="list_admin.do">게시판 관리 페이지</a></h2><p style="display:inline;">&nbsp;&nbsp;&nbsp;게시판 관리 페이지입니다.</p>
			...
			<table class="table" >
				...
				<tr>
					<td colspan="10" style="text-align: center"><pageObject:pageNav
							listURI="list_admin.do" pageObject="${pageObject }" /></td>
				</tr>
			</table>
